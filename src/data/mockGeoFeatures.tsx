...
export type Properties = { name:string }
export type Coordinate = [number,number];
export interface Polygon extends Geometry<Coordinate[][]>{}
export interface MultiPolygon extends Geometry<Coordinate[][][]>{}
...
export const geoFeatures:GeoFeatures = {
